...
<head>
  ...
  <style>
   body {
      ...
      background: linear-gradient(to bottom, #000000, #14213D);
      color: white;
    }
...
<body class="bg-gradient-to-b from-[#14213D] via-[#0f111a] to-black text-white font-sans">
  <div class="navbar bg-[#14213D] text-[#FCA311] p-4 flex justify-between items-center">
    <div class="logo flex items-center gap-2">
      <i class="fa-solid fa-burger"></i>
      <span class="font-pacifico text-xl">SoulMade</span>
    </div>
   <div class="user-actions space-x-2">
      <?php if (isset($_SESSION['id_client'])): ?>
        <button class="bg-white text-black px-3 py-1 rounded-full" onclick="window.location.href='profil.php'">Mon Profil</button>
        <button class="bg-red-600 text-white px-3 py-1 rounded-full" onclick="window.location.href='logout.php'">Se déconnecter</button>
      <?php else: ?>
       <button class="bg-white text-black px-3 py-1 rounded-full" onclick="window.location.href='login.php'">Se connecter</button>
      <?php endif; ?>
    </div>
  </div>

    <?php if (isset($_SESSION['error'])): ?>
         <div class="text-red-500 text-center font-bold my-4">
